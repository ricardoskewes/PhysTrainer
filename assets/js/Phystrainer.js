...
// DISTRIBUCIÓN NORMAL USANDO LA TRANSFORMACIÓN DE BOX-MULLER.

function randn_bm(mu, delta) {
...
function hallarRangoLog(expMin, expMax) {
    do {
...
//y = Ax + B
function generarParamLineal(limX, limY) {
...
// y = Ae^(Bx)
function generarParamExponencial(limX,limY) {
...
// y = Ax^B
function generarParamPotencial(limX,limY) {
